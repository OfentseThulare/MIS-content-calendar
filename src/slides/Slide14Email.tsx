    ...
    <SlideFrame>
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <PlaceholderZone label="EMAIL DESIGN CONCEPTS TO BE ADDED" />
        </div>
      </div>
    </SlideFrame>
  )
