...
export default function Slide10SegmentSponsors() {
  return (
    <SlideFrame bg={brand.colors.lightBg} textColor={brand.colors.bodyText} showChrome pageNumber={10} totalPages={31}>
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', gap: 32 }}>
        ...
        <div style={{ maxWidth: 1400 }}>
          <SegmentCard
            ...
            channels="Named outreach via Clay-powered personalised email and LinkedIn InMail. Six named accounts: Sibanye-Stillwater, Harmony Gold, NYDA, Impala or Northam, OEM suppliers, Bojanala District Municipality."
