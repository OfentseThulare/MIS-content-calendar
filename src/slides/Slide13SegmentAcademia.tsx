...
export default function Slide13SegmentAcademia() {
  return (
    <SlideFrame bg={brand.colors.lightBg} textColor={brand.colors.bodyText} showChrome pageNumber={13} totalPages={30}>
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', gap: 32 }}>
        ...
        <div style={{ maxWidth: 1400 }}>
          <SegmentCard
            ...
            badge="80 learners, 40 tertiary students, 30 academics"
            who="Mining Engineering at Wits, UP, Stellenbosch. Eight partner school HODs. NYDA and SAIMM."
            hook="Your project gets judged on stage. Winners get funded inside 90 days."
            channels="TikTok and Instagram for learner mobilisation, parent WhatsApp groups, school principal briefings"
