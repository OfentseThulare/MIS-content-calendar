...
const bullets = [
  'Tier one mining press embargo programme',
  'Op ed placement, six publications across three markets',
  'Press accreditation and media partnership framework',
  'Post summit coverage and report distribution',
]

export default function Slide15PrMedia() {
  return (
    <SlideFrame>
      <div
        style={{
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <PlaceholderZone label="MEDIA KIT CONCEPTS TO BE ADDED" />
        </div>
      </div>
    </SlideFrame>
  )
